...
void Resource_Init(void)
{
    ...
    UTIL_TIM_BASE_CFG(TIM2, 999, 71, TIM_CKD_DIV1, TIM_CounterMode_Up); /*配置定时器基本参数,目标是 TIM2*/
     ...
     */
    UTIL_TIM_BASE_CFG(TIM3, 49999, 7199, TIM_CKD_DIV1, TIM_CounterMode_Up); /*配置 TIM3，每 5 秒触发一次中断*/
