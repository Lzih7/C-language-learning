...
void Resource_Init(void)
{
    ...
    UTIL_GPIO_CFG(GPIOB, GPIO_Pin_10, GPIO_Speed_50MHz, GPIO_Mode_IPU);  /*PB0 为上拉输入，用于按键输入,BUTTON*/
    ...
    UTIL_TIM_BASE_CFG(TIM3, 4999, 7199, TIM_CKD_DIV1, TIM_CounterMode_Up); /*配置 TIM3，每 0.5 秒触发一次中断*/
